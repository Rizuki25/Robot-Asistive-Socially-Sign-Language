"""Normalisasi selektif video dataset huruf ke 90 frame pada 30 FPS.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Normalisasi selektif dataset huruf menjadi 90 frame @ 30 FPS"
        )
    )
    parser.add_argument(
        "--input_dir",
        default="dataset/letters/raw",
        help="Folder sumber per kelas (default: dataset/letters/raw)",
    )
    parser.add_argument(
        "--output_dir",
        default="dataset/letters/raw_90",
        help="Folder output baru (default: dataset/letters/raw_90)",
    )
    parser.add_argument(
        "--target_frames",
        type=int,
...
def main() -> None:
    ...
    print("=" * 60)
    print("NORMALISASI SELEKTIF VIDEO DATASET HURUF")
